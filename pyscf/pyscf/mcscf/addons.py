...
# but undefined in fcibase object
            ...
            e_states[0] = e
            #HERE#print('BM_B',casscf.verbose,logger.DEBUG,has_spin_square)
            if casscf.verbose >= logger.DEBUG:
                if has_spin_square:
    ...
    def _finalize():
        ...
        #HERE#print('BM_C',casscf.verbose,logger.DEBUG,has_spin_square)
        if has_spin_square:
            ncas = casscf.ncas
            nelecas = casscf.nelecas
    ...
    class FakeCISolver(fcibase_class, StateAverageFCISolver):
        ...
        def kernel(self, h1, h2, norb, nelec, ci0=None, **kwargs):
            ...
            if state == 0:
                ...
                c = [c]
            self._civec = c
            #HERE#print('BM_D',casscf.verbose,logger.DEBUG,hasattr(fcibase_class, 'spin_square'))
            if casscf.verbose >= logger.DEBUG:
...
# Note self.orbsym is initialized lazily in mc1step_symm.kernel function
            #HERE#print('BM_E','launch_kernel')
            #HERE#print('BM_E',fcibase_class.__name__)
            #HERE#print('BM_E',list(set([f.prefix for f in fcisolvers])))
            ...
            #HERE#print('BM_E',log.verbose,logger.DEBUG,has_spin_square)
            if log.verbose >= logger.DEBUG-1:
                if has_spin_square:
    ...
    def _finalize():
        ...
        casscf.e_tot = e_states[0]
        logger.note(casscf, 'CASCI energy for each state')
        #HERE#print('BM_F',casscf.verbose,logger.DEBUG,has_spin_square)
        if has_spin_square:
            ncas = casscf.ncas
            nelecas = casscf.nelecas
        ...
        return casscf
    casscf._finalize = _finalize
    #HERE#print('BM_solvers_A',casscf)
    #HERE#print('BM_solvers_A',casscf.fcisolver.__class__)
    #HERE#print('BM_solvers_A',casscf.fcisolver.__class__.__name__)
    #HERE#print('BM_solvers_A',casscf.fcisolver.fcisolvers)
    return casscf
