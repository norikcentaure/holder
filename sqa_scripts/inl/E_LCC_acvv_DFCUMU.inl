namespace MRLCC_ACVV_DFCUMU {
  ...
  FEqInfo EqsRes[48] = {
    ...
    {"abcd,ecf,eag,bgfh,dh",      1.0,   5, { 6,15,19, 5,22}},     //   1.0 Ap[abcd] W[ecf] W[eag] p[bgfh] E1[dh] 
    {"abcd,ecf,eag,gbfh,dh",     -2.0,   5, { 6,15,19, 5,22}},     //  -2.0 Ap[abcd] W[ecf] W[eag] p[gbfh] E1[dh] 
    {"abcd,ecf,ebg,agfh,dh",     -2.0,   5, { 6,15,19, 5,22}},     //  -2.0 Ap[abcd] W[ecf] W[ebg] p[agfh] E1[dh] 
    {"abcd,ecf,ebg,gafh,dh",      1.0,   5, { 6,15,19, 5,22}},     //   1.0 Ap[abcd] W[ecf] W[ebg] p[gafh] E1[dh] 
    ...
    {"abcd,abef,gce,ghi,df,ih",  -4.0,   6, { 6, 5,15,15,22,21}},  //  -4.0 Ap[abcd] p[abef] W[gce] W[ghi] E1[df] delta[ih] 
    {"abcd,abef,gch,geh,df",      2.0,   5, { 6, 5,15,15,22}},     //   2.0 Ap[abcd] p[abef] W[gch] W[geh] E1[df] 
    {"abcd,baef,gce,ghi,df,ih",   2.0,   6, { 6, 5,15,15,22,21}},  //   2.0 Ap[abcd] p[baef] W[gce] W[ghi] E1[df] delta[ih] 
    {"abcd,baef,gch,geh,df",     -1.0,   5, { 6, 5,15,15,22}},     //  -1.0 Ap[abcd] p[baef] W[gch] W[geh] E1[df] 
    ...
    {"abcd,efg,ech,abhi,dfig",   -2.0,   5, { 6,11,15, 5,23}},     //  -2.0 Ap[abcd] W[efg] W[ech] p[abhi] E2[dfig] 
    {"abcd,efg,ech,bahi,dfig",    1.0,   5, { 6,11,15, 5,23}},     //   1.0 Ap[abcd] W[efg] W[ech] p[bahi] E2[dfig] 
