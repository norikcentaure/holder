namespace MRLCC_CAAV_DF {
  ...
  FEqInfo EqsRes[216] = {
    ...
    {"abcd,ebf,ega,gfhd,ch",       -2.0,   5, {11,20,24, 9,32}},     //  -2.0 Ap1[abcd] W[ebf] W[ega] p1[gfhd] E1[ch] 
    ...
    {"abcd,ebf,ega,gfhd,ch",        1.0,   5, {11,20,24,10,32}},     //   1.0 Ap1[abcd] W[ebf] W[ega] p2[gfhd] E1[ch] 
    ...
    {"abcd,efa,edg,fbhg,ch",       -2.0,   5, {11,24,28, 9,32}},     //  -2.0 Ap1[abcd] W[efa] W[edg] p1[fbhg] E1[ch] 
    {"abcd,efi,edg,abhg,ch,if",     4.0,   6, {11,24,28, 9,32,31}},  //   4.0 Ap1[abcd] W[efi] W[edg] p1[abhg] E1[ch] delta[if] 
    {"abcd,efa,edg,fbhg,ch",        1.0,   5, {11,24,28,10,32}},     //   1.0 Ap1[abcd] W[efa] W[edg] p2[fbhg] E1[ch] 
    ...
    {"abcd,ebfd,gea,ghi,cf,ih",    -4.0,   6, {11, 9,24,24,32,31}},  //  -4.0 Ap1[abcd] p1[ebfd] W[gea] W[ghi] E1[cf] delta[ih] 
    {"abcd,ebfd,gha,geh,cf",        2.0,   5, {11, 9,24,24,32}},     //   2.0 Ap1[abcd] p1[ebfd] W[gha] W[geh] E1[cf] 
    {"abcd,ebfd,gea,ghi,cf,ih",     2.0,   6, {11,10,24,24,32,31}},  //   2.0 Ap1[abcd] p2[ebfd] W[gea] W[ghi] E1[cf] delta[ih] 
    {"abcd,ebfd,gha,geh,cf",       -1.0,   5, {11,10,24,24,32}},     //  -1.0 Ap1[abcd] p2[ebfd] W[gha] W[geh] E1[cf] 
    {"abcd,ebf,ega,gfhd,ch",        1.0,   5, {12,20,24, 9,32}},     //   1.0 Ap2[abcd] W[ebf] W[ega] p1[gfhd] E1[ch] 
    ...
    {"abcd,ebf,ega,gfhd,ch",       -2.0,   5, {12,20,24,10,32}},     //  -2.0 Ap2[abcd] W[ebf] W[ega] p2[gfhd] E1[ch] 
    ...
    {"abcd,efa,edg,fbhg,ch",        1.0,   5, {12,24,28, 9,32}},     //   1.0 Ap2[abcd] W[efa] W[edg] p1[fbhg] E1[ch] 
    {"abcd,efi,edg,abhg,ch,if",    -2.0,   6, {12,24,28, 9,32,31}},  //  -2.0 Ap2[abcd] W[efi] W[edg] p1[abhg] E1[ch] delta[if] 
    {"abcd,efa,edg,fbhg,ch",       -2.0,   5, {12,24,28,10,32}},     //  -2.0 Ap2[abcd] W[efa] W[edg] p2[fbhg] E1[ch] 
    ...
    {"abcd,ebfd,gea,ghi,cf,ih",     2.0,   6, {12, 9,24,24,32,31}},  //   2.0 Ap2[abcd] p1[ebfd] W[gea] W[ghi] E1[cf] delta[ih] 
    {"abcd,ebfd,gha,geh,cf",       -1.0,   5, {12, 9,24,24,32}},     //  -1.0 Ap2[abcd] p1[ebfd] W[gha] W[geh] E1[cf] 
    {"abcd,ebfd,gea,ghi,cf,ih",    -4.0,   6, {12,10,24,24,32,31}},  //  -4.0 Ap2[abcd] p2[ebfd] W[gea] W[ghi] E1[cf] delta[ih] 
    {"abcd,ebfd,gha,geh,cf",        2.0,   5, {12,10,24,24,32}},     //   2.0 Ap2[abcd] p2[ebfd] W[gha] W[geh] E1[cf] 
    ...
    {"abcd,ebf,ega,ghid,chfi",     -2.0,   5, {11,20,24, 9,33}},     //  -2.0 Ap1[abcd] W[ebf] W[ega] p1[ghid] E2[chfi] 
    {"abcd,efg,eha,hbid,cfig",     -2.0,   5, {11,20,24, 9,33}},     //  -2.0 Ap1[abcd] W[efg] W[eha] p1[hbid] E2[cfig] 
    {"abcd,efg,eha,hgid,cfbi",     -2.0,   5, {11,20,24, 9,33}},     //  -2.0 Ap1[abcd] W[efg] W[eha] p1[hgid] E2[cfbi] 
    {"abcd,efg,ehj,agid,cfbi,jh",   4.0,   6, {11,20,24, 9,33,31}},  //   4.0 Ap1[abcd] W[efg] W[ehj] p1[agid] E2[cfbi] delta[jh] 
    {"abcd,efg,ehj,aifd,cibg,jh",  -4.0,   6, {11,20,24, 9,33,31}},  //  -4.0 Ap1[abcd] W[efg] W[ehj] p1[aifd] E2[cibg] delta[jh] 
    {"abcd,ebf,ega,ghid,chfi",      1.0,   5, {11,20,24,10,33}},     //   1.0 Ap1[abcd] W[ebf] W[ega] p2[ghid] E2[chfi] 
    {"abcd,efg,eha,hbid,cfig",      1.0,   5, {11,20,24,10,33}},     //   1.0 Ap1[abcd] W[efg] W[eha] p2[hbid] E2[cfig] 
    {"abcd,efg,eha,hgid,cfbi",      1.0,   5, {11,20,24,10,33}},     //   1.0 Ap1[abcd] W[efg] W[eha] p2[hgid] E2[cfbi] 
    {"abcd,efg,ehj,agid,cfbi,jh",  -2.0,   6, {11,20,24,10,33,31}},  //  -2.0 Ap1[abcd] W[efg] W[ehj] p2[agid] E2[cfbi] delta[jh] 
    ...
    {"abcd,efg,edh,agih,cfbi",      2.0,   5, {11,20,28, 9,33}},     //   2.0 Ap1[abcd] W[efg] W[edh] p1[agih] E2[cfbi] 
    ...
    {"abcd,efg,edh,agih,cfbi",     -1.0,   5, {11,20,28,10,33}},     //  -1.0 Ap1[abcd] W[efg] W[edh] p2[agih] E2[cfbi] 
    ...
    {"abcd,efa,edg,fhig,chbi",     -2.0,   5, {11,24,28, 9,33}},     //  -2.0 Ap1[abcd] W[efa] W[edg] p1[fhig] E2[chbi] 
    {"abcd,efj,edg,ahig,chbi,jf",   4.0,   6, {11,24,28, 9,33,31}},  //   4.0 Ap1[abcd] W[efj] W[edg] p1[ahig] E2[chbi] delta[jf] 
    {"abcd,efa,edg,fhig,chbi",      1.0,   5, {11,24,28,10,33}},     //   1.0 Ap1[abcd] W[efa] W[edg] p2[fhig] E2[chbi] 
    ...
    {"abcd,aefd,gbh,gie,cihf",      2.0,   5, {11, 9,20,20,33}},     //   2.0 Ap1[abcd] p1[aefd] W[gbh] W[gie] E2[cihf] 
    {"abcd,efgd,hea,hij,cfbg,ji",  -4.0,   6, {11, 9,24,24,33,31}},  //  -4.0 Ap1[abcd] p1[efgd] W[hea] W[hij] E2[cfbg] delta[ji] 
    {"abcd,efgd,hia,hei,cfbg",      2.0,   5, {11, 9,24,24,33}},     //   2.0 Ap1[abcd] p1[efgd] W[hia] W[hei] E2[cfbg] 
    ...
    {"abcd,aefd,gbh,gie,cihf",     -1.0,   5, {11,10,20,20,33}},     //  -1.0 Ap1[abcd] p2[aefd] W[gbh] W[gie] E2[cihf] 
    {"abcd,efgd,hea,hij,cfbg,ji",   2.0,   6, {11,10,24,24,33,31}},  //   2.0 Ap1[abcd] p2[efgd] W[hea] W[hij] E2[cfbg] delta[ji] 
    {"abcd,efgd,hia,hei,cfbg",     -1.0,   5, {11,10,24,24,33}},     //  -1.0 Ap1[abcd] p2[efgd] W[hia] W[hei] E2[cfbg] 
    {"abcd,ebf,ega,ghid,chfi",      1.0,   5, {12,20,24, 9,33}},     //   1.0 Ap2[abcd] W[ebf] W[ega] p1[ghid] E2[chfi] 
    {"abcd,efg,eha,hbid,cfig",      1.0,   5, {12,20,24, 9,33}},     //   1.0 Ap2[abcd] W[efg] W[eha] p1[hbid] E2[cfig] 
    {"abcd,efg,eha,hgid,cfbi",      1.0,   5, {12,20,24, 9,33}},     //   1.0 Ap2[abcd] W[efg] W[eha] p1[hgid] E2[cfbi] 
    {"abcd,efg,ehj,agid,cfbi,jh",  -2.0,   6, {12,20,24, 9,33,31}},  //  -2.0 Ap2[abcd] W[efg] W[ehj] p1[agid] E2[cfbi] delta[jh] 
    {"abcd,efg,ehj,aifd,cibg,jh",   2.0,   6, {12,20,24, 9,33,31}},  //   2.0 Ap2[abcd] W[efg] W[ehj] p1[aifd] E2[cibg] delta[jh] 
    {"abcd,ebf,ega,ghid,chif",      1.0,   5, {12,20,24,10,33}},     //   1.0 Ap2[abcd] W[ebf] W[ega] p2[ghid] E2[chif] 
    {"abcd,efg,eha,hbid,cfig",     -2.0,   5, {12,20,24,10,33}},     //  -2.0 Ap2[abcd] W[efg] W[eha] p2[hbid] E2[cfig] 
    {"abcd,efg,eha,hgid,cfib",      1.0,   5, {12,20,24,10,33}},     //   1.0 Ap2[abcd] W[efg] W[eha] p2[hgid] E2[cfib] 
    {"abcd,efg,ehj,agid,cfib,jh",  -2.0,   6, {12,20,24,10,33,31}},  //  -2.0 Ap2[abcd] W[efg] W[ehj] p2[agid] E2[cfib] delta[jh] 
    ...
    {"abcd,efg,edh,agih,cfbi",     -1.0,   5, {12,20,28, 9,33}},     //  -1.0 Ap2[abcd] W[efg] W[edh] p1[agih] E2[cfbi] 
    ...
    {"abcd,efg,edh,agih,cfib",     -1.0,   5, {12,20,28,10,33}},     //  -1.0 Ap2[abcd] W[efg] W[edh] p2[agih] E2[cfib] 
    ...
    {"abcd,efa,edg,fhig,chbi",      1.0,   5, {12,24,28, 9,33}},     //   1.0 Ap2[abcd] W[efa] W[edg] p1[fhig] E2[chbi] 
    {"abcd,efj,edg,ahig,chbi,jf",  -2.0,   6, {12,24,28, 9,33,31}},  //  -2.0 Ap2[abcd] W[efj] W[edg] p1[ahig] E2[chbi] delta[jf] 
    {"abcd,efa,edg,fhig,chib",      1.0,   5, {12,24,28,10,33}},     //   1.0 Ap2[abcd] W[efa] W[edg] p2[fhig] E2[chib] 
    ...
    {"abcd,aefd,gbh,gie,cihf",     -1.0,   5, {12, 9,20,20,33}},     //  -1.0 Ap2[abcd] p1[aefd] W[gbh] W[gie] E2[cihf] 
    {"abcd,efgd,hea,hij,cfbg,ji",   2.0,   6, {12, 9,24,24,33,31}},  //   2.0 Ap2[abcd] p1[efgd] W[hea] W[hij] E2[cfbg] delta[ji] 
    {"abcd,efgd,hia,hei,cfbg",     -1.0,   5, {12, 9,24,24,33}},     //  -1.0 Ap2[abcd] p1[efgd] W[hia] W[hei] E2[cfbg] 
    ...
    {"abcd,aefd,gbh,gie,cifh",     -1.0,   5, {12,10,20,20,33}},     //  -1.0 Ap2[abcd] p2[aefd] W[gbh] W[gie] E2[cifh] 
    {"abcd,efgd,hea,hij,cfgb,ji",   2.0,   6, {12,10,24,24,33,31}},  //   2.0 Ap2[abcd] p2[efgd] W[hea] W[hij] E2[cfgb] delta[ji] 
    {"abcd,efgd,hia,hei,cfgb",     -1.0,   5, {12,10,24,24,33}},     //  -1.0 Ap2[abcd] p2[efgd] W[hia] W[hei] E2[cfgb] 
    {"abcd,efg,eha,hijd,cfibgj",   -2.0,   5, {11,20,24, 9,35}},     //  -2.0 Ap1[abcd] W[efg] W[eha] p1[hijd] E3[cfibgj] 
    {"abcd,efg,eha,hijd,cfibgj",    1.0,   5, {11,20,24,10,35}},     //   1.0 Ap1[abcd] W[efg] W[eha] p2[hijd] E3[cfibgj] 
    ...
    {"abcd,aefd,ghe,gij,chibfj",    2.0,   5, {11, 9,20,20,35}},     //   2.0 Ap1[abcd] p1[aefd] W[ghe] W[gij] E3[chibfj] 
    {"abcd,aefd,gfh,gij,ceibhj",    1.0,   5, {11,10,20,20,35}},     //   1.0 Ap1[abcd] p2[aefd] W[gfh] W[gij] E3[ceibhj] 
    {"abcd,aefd,ghe,gij,chibfj",   -1.0,   5, {11,10,20,20,35}},     //  -1.0 Ap1[abcd] p2[aefd] W[ghe] W[gij] E3[chibfj] 
    {"abcd,efg,eha,hijd,cfibgj",    1.0,   5, {12,20,24, 9,35}},     //   1.0 Ap2[abcd] W[efg] W[eha] p1[hijd] E3[cfibgj] 
    {"abcd,efg,eha,hijd,cfijgb",    1.0,   5, {12,20,24,10,35}},     //   1.0 Ap2[abcd] W[efg] W[eha] p2[hijd] E3[cfijgb] 
    ...
    {"abcd,aefd,ghe,gij,chibfj",   -1.0,   5, {12, 9,20,20,35}},     //  -1.0 Ap2[abcd] p1[aefd] W[ghe] W[gij] E3[chibfj] 
    {"abcd,aefd,gfh,gij,ceihbj",    1.0,   5, {12,10,20,20,35}},     //   1.0 Ap2[abcd] p2[aefd] W[gfh] W[gij] E3[ceihbj] 
    {"abcd,aefd,ghe,gij,chifbj",   -1.0,   5, {12,10,20,20,35}},     //  -1.0 Ap2[abcd] p2[aefd] W[ghe] W[gij] E3[chifbj] 
  };
