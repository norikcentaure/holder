namespace NEVPT_AAAV {
  ...
  FEqInfo EqsRes[34] = {
    {"abgc,de,afhd,ce,gb,hf",      -1.0,   6, { 6,11, 5,15,14,14}},  //  -1.0 Ap[abgc] f[de] p[afhd] E1[ce] delta[gb] delta[hf] 
    {"abgc,ad,dehf,cf,gb,he",       1.0,   6, { 6,13, 5,15,14,14}},  //   1.0 Ap[abgc] f[ad] p[dehf] E1[cf] delta[gb] delta[he] 
    {"abhc,de,adfg,cefg,hb",        1.0,   5, { 6,11, 5,16,14}},     //   1.0 Ap[abhc] f[de] p[adfg] E2[cefg] delta[hb] 
    {"abhc,de,afdg,cfeg,hb",       -1.0,   5, { 6,11, 5,16,14}},     //  -1.0 Ap[abhc] f[de] p[afdg] E2[cfeg] delta[hb] 
    {"abhc,de,afgd,cfge,hb",       -1.0,   5, { 6,11, 5,16,14}},     //  -1.0 Ap[abhc] f[de] p[afgd] E2[cfge] delta[hb] 
    {"abcd,be,aefg,cdfg",           1.0,   4, { 6,11, 5,16}},        //   1.0 Ap[abcd] f[be] p[aefg] E2[cdfg] 
    {"abcd,ef,abeg,cdfg",          -1.0,   4, { 6,11, 5,16}},        //  -1.0 Ap[abcd] f[ef] p[abeg] E2[cdfg] 
    {"abcd,ef,abge,cdgf",          -1.0,   4, { 6,11, 5,16}},        //  -1.0 Ap[abcd] f[ef] p[abge] E2[cdgf] 
    {"abcd,ef,aghe,cdfb,hg",       -1.0,   5, { 6,11, 5,16,14}},     //  -1.0 Ap[abcd] f[ef] p[aghe] E2[cdfb] delta[hg] 
    ...
    {"abcd,ef,aegh,cdfgbh",         1.0,   4, { 6,11, 5,18}},        //   1.0 Ap[abcd] f[ef] p[aegh] E3[cdfgbh] 
    {"abcd,ef,ageh,cdgfbh",        -1.0,   4, { 6,11, 5,18}},        //  -1.0 Ap[abcd] f[ef] p[ageh] E3[cdgfbh] 
    {"abcd,ef,aghe,cdghbf",        -1.0,   4, { 6,11, 5,18}},        //  -1.0 Ap[abcd] f[ef] p[aghe] E3[cdghbf] 
  ...
  FEqInfo bVec[5] = {
    {"AUVW,APQR,WR,QP,VU",   1.0,   5, { 3,10,15,14,14}}, // 1.0 b[auvw] W[apqr] E1[wr] delta[qp] delta[vu]
    {"AUVW,APQR,VWRU,QP" ,   1.0,   4, { 3,10,16,14}   }, // 1.0 b[auvw] W[apqr] E2[vwru] delta[qp]
    {"AUVW,APQR,VWQR,PU" ,   1.0,   4, { 3,10,16,14}   }, // 1.0 b[auvw] W[apqr] E2[vwqr] delta[pu]
    {"AUVW,APQR,PWRQ,VU" ,   1.0,   4, { 3,10,16,14}   }, // 1.0 b[auvw] W[apqr] E2[pwrq] delta[vu]
    {"AUVW,APQR,PVWRQU"  ,   1.0,   3, { 3,10,18}      }, // 1.0 b[auvw] W[apqr] E3[pvwrqu]
  };
