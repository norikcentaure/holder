...
for this_class in ClassNames+class_en_plus:
  ...
  for hTerm in H:
    ...
    #for leftTerm in [Psi1Left[i] for i in  list_of_pt2_for_pt3]:      #when you want PT2
    #  for rightTerm in [Psi1Right[i] for i in  list_of_pt2_for_pt3]:  #when you want PT2
