...
Cin  = sqa.tensor('V', [i,p,q,r], [])
Cout = sqa.tensor('b', [j,u,v,w], [])
if (withC):
  Op1 = sqa.term( 1.0, [''],  [Cin,  sqa.sfExOp([q, i]) , sqa.sfExOp([r, p])])
  Op2 = sqa.term( 1.0, [''],  [Cout, sqa.sfExOp([u, w]) , sqa.sfExOp([j, v])])
else:
  Op1 = sqa.term( 1.0, [''],  [sqa.sfExOp([q, i]) , sqa.sfExOp([r, p])])
  Op2 = sqa.term( 1.0, [''],  [sqa.sfExOp([u, w]) , sqa.sfExOp([j, v])])
