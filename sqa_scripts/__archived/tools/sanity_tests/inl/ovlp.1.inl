...
// <E_cv E_cv  | E_vc E_vc > =    4
namespace MRLCC3 {

  FTensorDecl TensorDecls[11] = {
    ...
    /*  9*/{"delta"  , "cc"       , "", USAGE_Density     },
    /* 10*/{"delta"  , "ee"       , "", USAGE_Density     },
  };

	FEqInfo EqsRes[4] = {
    {"acbd,aebf,ca,db,ea,fb",   4.0,   6, { 8, 8,10, 9,10, 9}},  //   4.0 D[acbd] D[aebf] delta[ca] delta[db] delta[ea] delta[fb] 
    {"adbc,aecb,da,ea",        -2.0,   4, { 8, 8,10,10}},        //  -2.0 D[adbc] D[aecb] delta[da] delta[ea] 
    {"abcd,bace,dc,ec",        -2.0,   4, { 8, 8, 9, 9}},        //  -2.0 D[abcd] D[bace] delta[dc] delta[ec] 
    {"abcd,badc",               4.0,   2, { 8, 8}},              //   4.0 D[abcd] D[badc] 
	};
  ...
  static void GetMethodInfo(FMethodInfo &Out) {
    ...
    Out.nTensorDecls = 11;
    Out.EqsRes = FEqSet(&EqsRes[0], 4, "MRLCC3/Res");
  };
};
