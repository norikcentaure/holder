...
namespace MRLCC3 {
  ...
  FTensorDecl TensorDecls[12] = {
	...
	FEqInfo EqsRes[4] = {
    {"adbc,aebc,da,ea",        -2.0,   4, { 3, 3,10,10}},        //  -2.0 D[adbc] D[aebc] delta[da] delta[ea] 
    {"abcd,abcd",               4.0,   2, { 3, 3}},              //   4.0 D[abcd] D[abcd] 
    {"adbc,aebc,bf,da,ea,fb",   1.0,   6, { 3, 3,11,10,10, 9}},  //   1.0 D[adbc] D[aebc] E1[bf] delta[da] delta[ea] delta[fb] 
    {"abcd,abcd,ce,ec",        -2.0,   4, { 3, 3,11, 9}},        //  -2.0 D[abcd] D[abcd] E1[ce] delta[ec] 
	};
