...
// for V of class vvaa
// for V of class ccaa
// <E_ca E_ca  | E_aacc > =   14    Class:ccaa  
// for V of class vaca
// for V of class vaaa
// for V of class caaa
...
namespace MRLCC3 {
  ...
  FTensorDecl TensorDecls[13] = {
    /*  0*/{"AC"     , "ccaa"     , "", USAGE_Amplitude   },
    /*  1*/{"W"      , "ccaa"     , "", USAGE_Amplitude   },
    /*  2*/{"D"      , "aeca"     , "", USAGE_Hamiltonian },
    /*  3*/{"D"      , "caaa"     , "", USAGE_Hamiltonian },
    /*  4*/{"D"      , "ccaa"     , "", USAGE_Hamiltonian },
    /*  5*/{"D"      , "ccae"     , "", USAGE_Hamiltonian },
    /*  6*/{"D"      , "eaaa"     , "", USAGE_Hamiltonian },
    /*  7*/{"D"      , "eaca"     , "", USAGE_Hamiltonian },
    /*  8*/{"D"      , "eeaa"     , "", USAGE_Hamiltonian },
    /*  9*/{"D"      , "eeca"     , "", USAGE_Hamiltonian },
    /* 10*/{"D"      , "eecc"     , "", USAGE_Hamiltonian },
    /* 11*/{"E1"     , "aa"       , "", USAGE_Density     },
    /* 12*/{"E2"     , "aaaa"     , "", USAGE_Density     },
  };

	FEqInfo EqsRes[14] = {
    {"abcd,abcd",        2.0,   2, { 0, 4}},     //   2.0 AC[abcd] D[abcd] 
    {"abcd,abdc",       -1.0,   2, { 0, 4}},     //  -1.0 AC[abcd] D[abdc] 
    {"abcd,bacd",       -1.0,   2, { 0, 4}},     //  -1.0 AC[abcd] D[bacd] 
    {"abcd,badc",        2.0,   2, { 0, 4}},     //   2.0 AC[abcd] D[badc] 
    {"abcd,abce,de",    -1.0,   3, { 0, 4,11}},  //  -1.0 AC[abcd] D[abce] E1[de] 
    {"abcd,abde,ce",     0.5,   3, { 0, 4,11}},  //   0.5 AC[abcd] D[abde] E1[ce] 
    {"abcd,abec,de",     0.5,   3, { 0, 4,11}},  //   0.5 AC[abcd] D[abec] E1[de] 
    {"abcd,abed,ce",    -1.0,   3, { 0, 4,11}},  //  -1.0 AC[abcd] D[abed] E1[ce] 
    {"abcd,bace,de",     0.5,   3, { 0, 4,11}},  //   0.5 AC[abcd] D[bace] E1[de] 
    {"abcd,bade,ce",    -1.0,   3, { 0, 4,11}},  //  -1.0 AC[abcd] D[bade] E1[ce] 
    {"abcd,baec,de",    -1.0,   3, { 0, 4,11}},  //  -1.0 AC[abcd] D[baec] E1[de] 
    {"abcd,baed,ce",     0.5,   3, { 0, 4,11}},  //   0.5 AC[abcd] D[baed] E1[ce] 
    {"abcd,abef,cdef",   0.5,   3, { 0, 4,12}},  //   0.5 AC[abcd] D[abef] E2[cdef] 
    {"abcd,baef,cdfe",   0.5,   3, { 0, 4,12}},  //   0.5 AC[abcd] D[baef] E2[cdfe] 
	};
