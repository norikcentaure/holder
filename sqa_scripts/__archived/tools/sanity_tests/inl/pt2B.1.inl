...
namespace MRLCC3 {
  ...
  FTensorDecl TensorDecls[11] = {
    /*  0*/{"AC"     , "eecc"     , "", USAGE_Amplitude   },
    /*  1*/{"W"      , "eecc"     , "", USAGE_Amplitude   },
	...
	FEqInfo EqsRes[4] = {
    {"abcd,abcd",   2.0,   2, { 0,10}},  //   2.0 AC[abcd] D[abcd] 
    {"abcd,abdc",  -1.0,   2, { 0,10}},  //  -1.0 AC[abcd] D[abdc] 
    {"abcd,bacd",  -1.0,   2, { 0,10}},  //  -1.0 AC[abcd] D[bacd] 
    {"abcd,badc",   2.0,   2, { 0,10}},  //   2.0 AC[abcd] D[badc] 
	};
