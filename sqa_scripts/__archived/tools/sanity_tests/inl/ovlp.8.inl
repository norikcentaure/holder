...
namespace MRLCC3 {
  ...
  FTensorDecl TensorDecls[13] = {
	...
	FEqInfo EqsRes[4] = {
    {"abdc,acbe,cf,db,eb,fc",        1.0,   6, { 4, 4,10, 9, 9, 9}},     //   1.0 D[abdc] D[acbe] E1[cf] delta[db] delta[eb] delta[fc] 
    {"abcd,aceb,bcgf,dc,ec,fb,gc",   2.0,   7, { 4, 4,11, 9, 9, 9, 9}},  //   2.0 D[abcd] D[aceb] E2[bcgf] delta[dc] delta[ec] delta[fb] delta[gc] 
    {"abcd,adcb,cdef,ec,fd",         1.0,   5, { 4, 4,11, 9, 9}},        //   1.0 D[abcd] D[adcb] E2[cdef] delta[ec] delta[fd] 
    {"abcd,adcb,bcdgfe,eb,fc,gd",    1.0,   6, { 4, 4,12, 9, 9, 9}},     //   1.0 D[abcd] D[adcb] E3[bcdgfe] delta[eb] delta[fc] delta[gd] 
	};
