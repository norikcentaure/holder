...
namespace MRLCC3 {
  ...
  FTensorDecl TensorDecls[12] = {
    /*  0*/{"AC"     , "ccae"     , "", USAGE_Amplitude   },
    /*  1*/{"W"      , "ccae"     , "", USAGE_Amplitude   },
	...
	FEqInfo EqsRes[4] = {
    {"abcd,abcd",      4.0,   2, { 0, 5}},     //   4.0 AC[abcd] D[abcd] 
    {"abcd,bacd",     -2.0,   2, { 0, 5}},     //  -2.0 AC[abcd] D[bacd] 
    {"abcd,abed,ce",  -2.0,   3, { 0, 5,11}},  //  -2.0 AC[abcd] D[abed] E1[ce] 
    {"abcd,baed,ce",   1.0,   3, { 0, 5,11}},  //   1.0 AC[abcd] D[baed] E1[ce] 
	};
