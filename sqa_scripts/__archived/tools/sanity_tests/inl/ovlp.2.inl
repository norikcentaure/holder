...
namespace MRLCC3 {
  ...
  FTensorDecl TensorDecls[12] = {
	...
	FEqInfo EqsRes[2] = {
    {"adbc,aebc,cf,da,ea,fc",  -1.0,   6, { 7, 7,11,10,10, 9}},  //  -1.0 D[adbc] D[aebc] E1[cf] delta[da] delta[ea] delta[fc] 
    {"abcd,abcd,de,ed",         2.0,   4, { 7, 7,11, 9}},        //   2.0 D[abcd] D[abcd] E1[de] delta[ed] 
	};
