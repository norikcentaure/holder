...
// for V of class vaaa
// for V of class caaa
// <E_aa E_ca  | E_accc > =    6    Class:caaa  
// <E_aa E_ca  | E_ac   > =    3    Class:caaa  
// <E_aa E_ca  | E_aaac > =    7    Class:caaa  
// <E_aa E_ca  | E_avcv > =    0    Class:caaa  
// <E_aa E_ca  | E_avvc > =    0    Class:caaa  
// for V of class other
// for V of class h0
namespace MRLCC3 {

  FTensorDecl TensorDecls[19] = {
    /*  0*/{"AC"     , "caaa"     , "", USAGE_Amplitude   },
    /*  1*/{"AE"     , "ca"       , "", USAGE_Amplitude   },
    /*  2*/{"AE"     , "ccca"     , "", USAGE_Amplitude   },
    /*  3*/{"W"      , "caaa"     , "", USAGE_Amplitude   },
    /*  4*/{"W"      , "ccca"     , "", USAGE_Amplitude   },
    /*  5*/{"k"      , "ca"       , "", USAGE_Amplitude   },
	...
	FEqInfo EqsRes[16] = {
    {"afbc,bdce,de,fa",    -2.0,   4, { 2, 7,16,15}},  //  -2.0 AE[afbc] D[bdce] E1[de] delta[fa] 
    {"afbc,bdec,de,fa",     1.0,   4, { 2, 7,16,15}},  //   1.0 AE[afbc] D[bdec] E1[de] delta[fa] 
    {"abfc,bdce,de,fa",     4.0,   4, { 2, 7,16,15}},  //   4.0 AE[abfc] D[bdce] E1[de] delta[fa] 
    {"abfc,bdec,de,fa",    -2.0,   4, { 2, 7,16,15}},  //  -2.0 AE[abfc] D[bdec] E1[de] delta[fa] 
    {"agbc,bdef,cdef,ga",   1.0,   4, { 2, 7,17,15}},  //   1.0 AE[agbc] D[bdef] E2[cdef] delta[ga] 
    {"abgc,bdef,cdef,ga",  -2.0,   4, { 2, 7,17,15}},  //  -2.0 AE[abgc] D[bdef] E2[cdef] delta[ga] 
    {"ab,acbd,cd",          2.0,   3, { 1, 7,16}},     //   2.0 AE[ab] D[acbd] E1[cd] 
    {"ab,acdb,cd",         -1.0,   3, { 1, 7,16}},     //  -1.0 AE[ab] D[acdb] E1[cd] 
    {"ab,acde,bcde",       -1.0,   3, { 1, 7,17}},     //  -1.0 AE[ab] D[acde] E2[bcde] 
    {"abcd,aebc,ed",       -1.0,   3, { 0, 7,16}},     //  -1.0 AC[abcd] D[aebc] E1[ed] 
    {"abcd,aecb,ed",        2.0,   3, { 0, 7,16}},     //   2.0 AC[abcd] D[aecb] E1[ed] 
    {"abcd,aebf,cedf",     -1.0,   3, { 0, 7,17}},     //  -1.0 AC[abcd] D[aebf] E2[cedf] 
    {"abcd,aecf,bedf",      2.0,   3, { 0, 7,17}},     //   2.0 AC[abcd] D[aecf] E2[bedf] 
    {"abcd,aefb,cefd",     -1.0,   3, { 0, 7,17}},     //  -1.0 AC[abcd] D[aefb] E2[cefd] 
    {"abcd,aefc,bedf",     -1.0,   3, { 0, 7,17}},     //  -1.0 AC[abcd] D[aefc] E2[bedf] 
    {"abcd,aefg,bcedfg",   -1.0,   3, { 0, 7,18}},     //  -1.0 AC[abcd] D[aefg] E3[bcedfg] 
	};
  ...
  static void GetMethodInfo(FMethodInfo &Out) {
    ...
    Out.nTensorDecls = 19;
    Out.EqsRes = FEqSet(&EqsRes[0], 16, "MRLCC3/Res");
  };
};
