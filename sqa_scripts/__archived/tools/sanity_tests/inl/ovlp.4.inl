...
namespace MRLCC3 {
  ...
  FTensorDecl TensorDecls[12] = {
	...
	FEqInfo EqsRes[2] = {
    {"adbc,aecb,bcgf,da,ea,fb,gc",   1.0,   7, { 6, 6,11,10,10, 9, 9}},  //   1.0 D[adbc] D[aecb] E2[bcgf] delta[da] delta[ea] delta[fb] delta[gc] 
    {"abcd,badc,cdef,ec,fd",         1.0,   5, { 6, 6,11, 9, 9}},        //   1.0 D[abcd] D[badc] E2[cdef] delta[ec] delta[fd] 
	};
  ...
  static void GetMethodInfo(FMethodInfo &Out) {
    ...
    Out.nTensorDecls = 12;
    Out.EqsRes = FEqSet(&EqsRes[0], 2, "MRLCC3/Res");
  };
};
