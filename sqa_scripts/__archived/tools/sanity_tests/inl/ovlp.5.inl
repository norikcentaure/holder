...
// <E_ca E_ca  | E_ac E_ac > =   10
namespace MRLCC3 {

  FTensorDecl TensorDecls[13] = {
    /*  0*/{"D"      , "aeca"     , "", USAGE_Hamiltonian },
    /*  1*/{"D"      , "caaa"     , "", USAGE_Hamiltonian },
    /*  2*/{"D"      , "ccaa"     , "", USAGE_Hamiltonian },
    /*  3*/{"D"      , "ccae"     , "", USAGE_Hamiltonian },
    /*  4*/{"D"      , "eaaa"     , "", USAGE_Hamiltonian },
    /*  5*/{"D"      , "eaca"     , "", USAGE_Hamiltonian },
    /*  6*/{"D"      , "eeaa"     , "", USAGE_Hamiltonian },
    /*  7*/{"D"      , "eeca"     , "", USAGE_Hamiltonian },
    /*  8*/{"D"      , "eecc"     , "", USAGE_Hamiltonian },
    /*  9*/{"delta"  , "aa"       , "", USAGE_Density     },
    /* 10*/{"delta"  , "cc"       , "", USAGE_Density     },
    /* 11*/{"E1"     , "aa"       , "", USAGE_Density     },
    /* 12*/{"E2"     , "aaaa"     , "", USAGE_Density     },
  };

	FEqInfo EqsRes[10] = {
    {"acbd,aebf,ca,db,ea,fb",         4.0,   6, { 2, 2,10, 9,10, 9}},        //   4.0 D[acbd] D[aebf] delta[ca] delta[db] delta[ea] delta[fb] 
    {"adbc,aecb,da,ea",              -2.0,   4, { 2, 2,10,10}},              //  -2.0 D[adbc] D[aecb] delta[da] delta[ea] 
    {"abcd,bace,dc,ec",              -2.0,   4, { 2, 2, 9, 9}},              //  -2.0 D[abcd] D[bace] delta[dc] delta[ec] 
    {"abcd,badc",                     4.0,   2, { 2, 2}},                    //   4.0 D[abcd] D[badc] 
    {"acbd,aebf,bg,ca,db,ea,fb,gb",  -4.0,   8, { 2, 2,11,10, 9,10, 9, 9}},  //  -4.0 D[acbd] D[aebf] E1[bg] delta[ca] delta[db] delta[ea] delta[fb] delta[gb] 
    {"adbc,aecb,cf,da,ea,fc",         2.0,   6, { 2, 2,11,10,10, 9}},        //   2.0 D[adbc] D[aecb] E1[cf] delta[da] delta[ea] delta[fc] 
    {"abcd,bace,cf,dc,ec,fc",         2.0,   6, { 2, 2,11, 9, 9, 9}},        //   2.0 D[abcd] D[bace] E1[cf] delta[dc] delta[ec] delta[fc] 
    {"abcd,badc,de,ed",              -4.0,   4, { 2, 2,11, 9}},              //  -4.0 D[abcd] D[badc] E1[de] delta[ed] 
    {"adbc,aecb,bcgf,da,ea,fb,gc",    1.0,   7, { 2, 2,12,10,10, 9, 9}},     //   1.0 D[adbc] D[aecb] E2[bcgf] delta[da] delta[ea] delta[fb] delta[gc] 
    {"abcd,badc,cdef,ec,fd",          1.0,   5, { 2, 2,12, 9, 9}},           //   1.0 D[abcd] D[badc] E2[cdef] delta[ec] delta[fd] 
	};
  ...
  static void GetMethodInfo(FMethodInfo &Out) {
    ...
    Out.nTensorDecls = 13;
    Out.EqsRes = FEqSet(&EqsRes[0], 10, "MRLCC3/Res");
  };
};
