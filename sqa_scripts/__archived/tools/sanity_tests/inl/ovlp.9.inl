...
namespace MRLCC3 {
  ...
  FTensorDecl TensorDecls[13] = {
    ...
    /* 10*/{"E1"     , "aa"       , "", USAGE_Density     },
    /* 11*/{"E2"     , "aaaa"     , "", USAGE_Density     },
    /* 12*/{"E3"     , "aaaaaa"   , "", USAGE_Density     },
  };

	FEqInfo EqsRes[6] = {
    {"abdc,acbe,cf,db,eb,fc",       -1.0,   6, { 1, 1,10, 9, 9, 9}},     //  -1.0 D[abdc] D[acbe] E1[cf] delta[db] delta[eb] delta[fc] 
    {"abcd,adcb,de,ed",              2.0,   4, { 1, 1,10, 9}},           //   2.0 D[abcd] D[adcb] E1[de] delta[ed] 
    {"abcd,aceb,bcgf,dc,ec,fb,gc",  -2.0,   7, { 1, 1,11, 9, 9, 9, 9}},  //  -2.0 D[abcd] D[aceb] E2[bcgf] delta[dc] delta[ec] delta[fb] delta[gc] 
    {"abcd,adcb,bdfe,eb,fd",         2.0,   5, { 1, 1,11, 9, 9}},        //   2.0 D[abcd] D[adcb] E2[bdfe] delta[eb] delta[fd] 
    {"abcd,adcb,cdef,ec,fd",        -1.0,   5, { 1, 1,11, 9, 9}},        //  -1.0 D[abcd] D[adcb] E2[cdef] delta[ec] delta[fd] 
    {"abcd,adcb,bcdgfe,eb,fc,gd",   -1.0,   6, { 1, 1,12, 9, 9, 9}},     //  -1.0 D[abcd] D[adcb] E3[bcdgfe] delta[eb] delta[fc] delta[gd] 
	};
  ...
  static void GetMethodInfo(FMethodInfo &Out) {
    ...
    Out.nTensorDecls = 13;
    Out.EqsRes = FEqSet(&EqsRes[0], 6, "MRLCC3/Res");
  };
};
