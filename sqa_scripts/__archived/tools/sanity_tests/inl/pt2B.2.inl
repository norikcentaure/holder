...
namespace MRLCC3 {
  ...
  FTensorDecl TensorDecls[12] = {
    /*  0*/{"AC"     , "eeca"     , "", USAGE_Amplitude   },
    /*  1*/{"W"      , "eeca"     , "", USAGE_Amplitude   },
	...
	FEqInfo EqsRes[2] = {
    {"abcd,abce,ed",   2.0,   3, { 0, 9,11}},  //   2.0 AC[abcd] D[abce] E1[ed] 
    {"abcd,bace,ed",  -1.0,   3, { 0, 9,11}},  //  -1.0 AC[abcd] D[bace] E1[ed] 
	};
