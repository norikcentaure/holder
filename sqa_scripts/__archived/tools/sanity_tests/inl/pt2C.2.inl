...
// for V of class h0
// <E_av E_cv  | E_vc E_va > =    8
// <E_av E_cv  | E_vc E_va > =    2
// <E_av E_cv  | E_vc E_va > =    8
// <E_av E_cv  | E_vc E_va > =    8
// <E_av E_cv  | E_vc E_va > =    4
// <E_av E_cv  | E_vc E_va > =    4
// <E_av E_cv  | E_vc E_va > =    4
// <E_av E_cv  | E_vc E_va > =    2
// <E_av E_cv  | E_vc E_va > =    4
...
namespace MRLCC3 {
  ...
  FTensorDecl TensorDecls[36] = {
	...
	FEqInfo EqsRes[56] = {
    {"abhc,debf,decg,gf,ha",  -2.0,   5, { 6,31,31,34,33}},  //  -2.0 AO[abhc] D[debf] D[decg] E1[gf] delta[ha] 
    {"abhc,debf,edcg,gf,ha",   1.0,   5, { 6,31,31,34,33}},  //   1.0 AO[abhc] D[debf] D[edcg] E1[gf] delta[ha] 
    {"abhc,deaf,decg,gf,hb",   1.0,   5, { 6,31,31,34,33}},  //   1.0 AO[abhc] D[deaf] D[decg] E1[gf] delta[hb] 
    {"abhc,deaf,edcg,gf,hb",  -0.5,   5, { 6,31,31,34,33}},  //  -0.5 AO[abhc] D[deaf] D[edcg] E1[gf] delta[hb] 
    {"abch,debf,decg,gf,ha",   1.0,   5, { 6,31,31,34,33}},  //   1.0 AO[abch] D[debf] D[decg] E1[gf] delta[ha] 
    {"abch,debf,edcg,gf,ha",  -0.5,   5, { 6,31,31,34,33}},  //  -0.5 AO[abch] D[debf] D[edcg] E1[gf] delta[ha] 
    {"abch,deaf,decg,gf,hb",  -2.0,   5, { 6,31,31,34,33}},  //  -2.0 AO[abch] D[deaf] D[decg] E1[gf] delta[hb] 
    {"abch,deaf,edcg,gf,hb",   1.0,   5, { 6,31,31,34,33}},  //   1.0 AO[abch] D[deaf] D[edcg] E1[gf] delta[hb] 
    {"ab,cdae,cdbf,ef",       -2.0,   4, { 4,31,31,34}},     //  -2.0 AO[ab] D[cdae] D[cdbf] E1[ef] 
    {"ab,cdae,dcbf,ef",        1.0,   4, { 4,31,31,34}},     //   1.0 AO[ab] D[cdae] D[dcbf] E1[ef] 
    {"abhc,bdef,cdeg,fg,ha",   4.0,   5, { 7,31,31,34,33}},  //   4.0 AO[abhc] D[bdef] D[cdeg] E1[fg] delta[ha] 
    {"abhc,bdef,dceg,fg,ha",  -2.0,   5, { 7,31,31,34,33}},  //  -2.0 AO[abhc] D[bdef] D[dceg] E1[fg] delta[ha] 
    {"abhc,dbef,cdeg,fg,ha",  -2.0,   5, { 7,31,31,34,33}},  //  -2.0 AO[abhc] D[dbef] D[cdeg] E1[fg] delta[ha] 
    {"abhc,dbef,dceg,fg,ha",   4.0,   5, { 7,31,31,34,33}},  //   4.0 AO[abhc] D[dbef] D[dceg] E1[fg] delta[ha] 
    {"abcd,deaf,becg,gf",     -2.0,   4, { 7,31,31,34}},     //  -2.0 AO[abcd] D[deaf] D[becg] E1[gf] 
    {"abcd,deaf,ebcg,gf",      1.0,   4, { 7,31,31,34}},     //   1.0 AO[abcd] D[deaf] D[ebcg] E1[gf] 
    {"abcd,edaf,becg,gf",      1.0,   4, { 7,31,31,34}},     //   1.0 AO[abcd] D[edaf] D[becg] E1[gf] 
    {"abcd,edaf,ebcg,gf",     -2.0,   4, { 7,31,31,34}},     //  -2.0 AO[abcd] D[edaf] D[ebcg] E1[gf] 
    {"abch,adef,bdeg,gf,hc",  -2.0,   5, {10,31,31,34,33}},  //  -2.0 AO[abch] D[adef] D[bdeg] E1[gf] delta[hc] 
    {"abch,adef,dbeg,gf,hc",   1.0,   5, {10,31,31,34,33}},  //   1.0 AO[abch] D[adef] D[dbeg] E1[gf] delta[hc] 
    {"abch,daef,bdeg,gf,hc",   1.0,   5, {10,31,31,34,33}},  //   1.0 AO[abch] D[daef] D[bdeg] E1[gf] delta[hc] 
    {"abch,daef,dbeg,gf,hc",  -2.0,   5, {10,31,31,34,33}},  //  -2.0 AO[abch] D[daef] D[dbeg] E1[gf] delta[hc] 
    {"abcd,aecf,bedg,gf",      4.0,   4, {10,31,31,34}},     //   4.0 AO[abcd] D[aecf] D[bedg] E1[gf] 
    {"abcd,aecf,ebdg,gf",     -2.0,   4, {10,31,31,34}},     //  -2.0 AO[abcd] D[aecf] D[ebdg] E1[gf] 
    {"abcd,eacf,bedg,gf",     -2.0,   4, {10,31,31,34}},     //  -2.0 AO[abcd] D[eacf] D[bedg] E1[gf] 
    {"abcd,eacf,ebdg,gf",      1.0,   4, {10,31,31,34}},     //   1.0 AO[abcd] D[eacf] D[ebdg] E1[gf] 
    {"ahbc,defb,defg,gc,ha",   2.0,   5, { 5,31,31,34,33}},  //   2.0 AO[ahbc] D[defb] D[defg] E1[gc] delta[ha] 
    {"ahbc,defb,edfg,gc,ha",  -1.0,   5, { 5,31,31,34,33}},  //  -1.0 AO[ahbc] D[defb] D[edfg] E1[gc] delta[ha] 
    {"abcd,efag,efbh,cgdh",    1.0,   4, { 5,31,31,35}},     //   1.0 AO[abcd] D[efag] D[efbh] E2[cgdh] 
    {"abcd,efag,febh,cghd",    1.0,   4, { 5,31,31,35}},     //   1.0 AO[abcd] D[efag] D[febh] E2[cghd] 
    {"abhc,defb,defg,gc,ha",  -4.0,   5, { 3,31,31,34,33}},  //  -4.0 AO[abhc] D[defb] D[defg] E1[gc] delta[ha] 
    {"abhc,defb,edfg,gc,ha",   2.0,   5, { 3,31,31,34,33}},  //   2.0 AO[abhc] D[defb] D[edfg] E1[gc] delta[ha] 
    {"abcd,efag,efch,bhdg",   -2.0,   4, { 3,31,31,35}},     //  -2.0 AO[abcd] D[efag] D[efch] E2[bhdg] 
    {"abcd,efag,fech,bhdg",    1.0,   4, { 3,31,31,35}},     //   1.0 AO[abcd] D[efag] D[fech] E2[bhdg] 
    {"abcd,efga,efgh,bhdc",   -1.0,   4, { 1,31,31,35}},     //  -1.0 AO[abcd] D[efga] D[efgh] E2[bhdc] 
    {"abcd,efga,fegh,bhdc",    0.5,   4, { 1,31,31,35}},     //   0.5 AO[abcd] D[efga] D[fegh] E2[bhdc] 
    {"abcd,efgb,efgh,ahcd",   -1.0,   4, { 1,31,31,35}},     //  -1.0 AO[abcd] D[efgb] D[efgh] E2[ahcd] 
    {"abcd,efgb,fegh,ahcd",    0.5,   4, { 1,31,31,35}},     //   0.5 AO[abcd] D[efgb] D[fegh] E2[ahcd] 
    {"ab,cdeb,cdef,fa",       -2.0,   4, { 0,31,31,34}},     //  -2.0 AO[ab] D[cdeb] D[cdef] E1[fa] 
    {"ab,cdeb,dcef,fa",        1.0,   4, { 0,31,31,34}},     //   1.0 AO[ab] D[cdeb] D[dcef] E1[fa] 
    {"abcd,befg,defh,agch",    2.0,   4, { 2,31,31,35}},     //   2.0 AO[abcd] D[befg] D[defh] E2[agch] 
    {"abcd,befg,edfh,agch",   -1.0,   4, { 2,31,31,35}},     //  -1.0 AO[abcd] D[befg] D[edfh] E2[agch] 
    {"abcd,ebfg,defh,agch",   -1.0,   4, { 2,31,31,35}},     //  -1.0 AO[abcd] D[ebfg] D[defh] E2[agch] 
    {"abcd,ebfg,edfh,agch",    2.0,   4, { 2,31,31,35}},     //   2.0 AO[abcd] D[ebfg] D[edfh] E2[agch] 
    {"abcd,aefg,befh,chdg",   -1.0,   4, { 9,31,31,35}},     //  -1.0 AO[abcd] D[aefg] D[befh] E2[chdg] 
    {"abcd,aefg,ebfh,chgd",   -1.0,   4, { 9,31,31,35}},     //  -1.0 AO[abcd] D[aefg] D[ebfh] E2[chgd] 
    {"abcd,eafg,befh,chgd",   -1.0,   4, { 9,31,31,35}},     //  -1.0 AO[abcd] D[eafg] D[befh] E2[chgd] 
    {"abcd,eafg,ebfh,chgd",    2.0,   4, { 9,31,31,35}},     //   2.0 AO[abcd] D[eafg] D[ebfh] E2[chgd] 
    {"abcd,abef,cdeg,fg",      1.0,   4, {11,31,31,34}},     //   1.0 AO[abcd] D[abef] D[cdeg] E1[fg] 
    {"abcd,abef,dceg,fg",     -0.5,   4, {11,31,31,34}},     //  -0.5 AO[abcd] D[abef] D[dceg] E1[fg] 
    {"abcd,baef,cdeg,fg",     -0.5,   4, {11,31,31,34}},     //  -0.5 AO[abcd] D[baef] D[cdeg] E1[fg] 
    {"abcd,baef,dceg,fg",      1.0,   4, {11,31,31,34}},     //   1.0 AO[abcd] D[baef] D[dceg] E1[fg] 
    {"ab,acde,bcdf,fe",        2.0,   4, { 8,31,31,34}},     //   2.0 AO[ab] D[acde] D[bcdf] E1[fe] 
    {"ab,acde,cbdf,fe",       -1.0,   4, { 8,31,31,34}},     //  -1.0 AO[ab] D[acde] D[cbdf] E1[fe] 
    {"ab,cade,bcdf,fe",       -1.0,   4, { 8,31,31,34}},     //  -1.0 AO[ab] D[cade] D[bcdf] E1[fe] 
    {"ab,cade,cbdf,fe",        2.0,   4, { 8,31,31,34}},     //   2.0 AO[ab] D[cade] D[cbdf] E1[fe] 
	};
  ...
  static void GetMethodInfo(FMethodInfo &Out) {
    ...
    Out.nTensorDecls = 36;
    Out.EqsRes = FEqSet(&EqsRes[0], 56, "MRLCC3/Res");
  };
};
