...
namespace MRLCC3 {
  ...
  FTensorDecl TensorDecls[12] = {
	...
	FEqInfo EqsRes[8] = {
    {"abcd,adcb,de,ed",        2.0,   4, { 5, 5,10, 9}},     //   2.0 D[abcd] D[adcb] E1[de] delta[ed] 
    {"abcd,adcb,bdfe,eb,fd",   2.0,   5, { 5, 5,11, 9, 9}},  //   2.0 D[abcd] D[adcb] E2[bdfe] delta[eb] delta[fd] 
    {"abcd,beca,ed",          -1.0,   3, { 0, 5,10}},        //  -1.0 D[abcd] D[beca] E1[ed] 
    {"abcd,becf,aedf",        -1.0,   3, { 0, 5,11}},        //  -1.0 D[abcd] D[becf] E2[aedf] 
    {"abcd,bace,de",          -1.0,   3, { 0, 5,10}},        //  -1.0 D[abcd] D[bace] E1[de] 
    {"abcd,becf,deaf",        -1.0,   3, { 0, 5,11}},        //  -1.0 D[abcd] D[becf] E2[deaf] 
    {"abcd,abcd,de,ed",        2.0,   4, { 0, 0,10, 9}},     //   2.0 D[abcd] D[abcd] E1[de] delta[ed] 
    {"abcd,abcd,adef,ea,fd",  -1.0,   5, { 0, 0,11, 9, 9}},  //  -1.0 D[abcd] D[abcd] E2[adef] delta[ea] delta[fd] 
	};
  ...
  static void GetMethodInfo(FMethodInfo &Out) {
    ...
    Out.nTensorDecls = 12;
    Out.EqsRes = FEqSet(&EqsRes[0], 8, "MRLCC3/Res");
  };
};
