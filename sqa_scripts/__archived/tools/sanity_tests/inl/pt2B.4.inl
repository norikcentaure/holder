...
namespace MRLCC3 {
  ...
  FTensorDecl TensorDecls[12] = {
    /*  0*/{"AC"     , "eeaa"     , "", USAGE_Amplitude   },
    /*  1*/{"W"      , "eeaa"     , "", USAGE_Amplitude   },
	...
	FEqInfo EqsRes[2] = {
    {"abcd,abef,efcd",   0.5,   3, { 0, 8,11}},  //   0.5 AC[abcd] D[abef] E2[efcd] 
    {"abcd,baef,efdc",   0.5,   3, { 0, 8,11}},  //   0.5 AC[abcd] D[baef] E2[efdc] 
	};
