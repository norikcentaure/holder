...
// for V of class ccaa
// for V of class vaca
// <E_aa E_cv  | E_cvcc > =    2    Class:vaca  
// <E_av E_ca  | E_cvcc > =    2    Class:vaca  
// <E_aa E_cv  | E_avca > =    2    Class:vaca  
// <E_av E_ca  | E_avca > =    2    Class:vaca  
// <E_aa E_cv  | E_avac > =    2    Class:vaca  
// <E_av E_ca  | E_avac > =    2    Class:vaca  
// <E_aa E_cv  | E_vc   > =    1    Class:vaca  
// <E_av E_ca  | E_vc   > =    1    Class:vaca  
// <E_aa E_cv  | E_vvcv > =    0    Class:vaca  
// <E_av E_ca  | E_vvcv > =    0    Class:vaca  
// for V of class vaaa
// for V of class caaa
...
namespace MRLCC3 {
  ...
  FTensorDecl TensorDecls[20] = {
    ...
    /*  1*/{"AC"     , "eaca"     , "", USAGE_Amplitude   },
    /*  2*/{"AE"     , "ccce"     , "", USAGE_Amplitude   },
    /*  3*/{"AE"     , "ec"       , "", USAGE_Amplitude   },
    /*  4*/{"W"      , "aeca"     , "", USAGE_Amplitude   },
    /*  5*/{"W"      , "ccce"     , "", USAGE_Amplitude   },
    /*  6*/{"W"      , "eaca"     , "", USAGE_Amplitude   },
    /*  7*/{"k"      , "ec"       , "", USAGE_Amplitude   },
	...
	FEqInfo EqsRes[14] = {
    {"afbc,cdbe,de,fa",  -2.0,   4, { 2,13,18,17}},  //  -2.0 AE[afbc] D[cdbe] E1[de] delta[fa] 
    {"abfc,cdbe,de,fa",   4.0,   4, { 2,13,18,17}},  //   4.0 AE[abfc] D[cdbe] E1[de] delta[fa] 
    {"afbc,dcbe,ed,fa",   1.0,   4, { 2, 8,18,17}},  //   1.0 AE[afbc] D[dcbe] E1[ed] delta[fa] 
    {"abfc,dcbe,ed,fa",  -2.0,   4, { 2, 8,18,17}},  //  -2.0 AE[abfc] D[dcbe] E1[ed] delta[fa] 
    {"abcd,beca,ed",     -1.0,   3, { 0,13,18}},     //  -1.0 AC[abcd] D[beca] E1[ed] 
    {"abcd,becf,aedf",   -1.0,   3, { 0,13,19}},     //  -1.0 AC[abcd] D[becf] E2[aedf] 
    {"abcd,abce,ed",      2.0,   3, { 0, 8,18}},     //   2.0 AC[abcd] D[abce] E1[ed] 
    {"abcd,ebcf,afed",   -1.0,   3, { 0, 8,19}},     //  -1.0 AC[abcd] D[ebcf] E2[afed] 
    {"abcd,aecb,ed",      2.0,   3, { 1,13,18}},     //   2.0 AC[abcd] D[aecb] E1[ed] 
    {"abcd,aecf,bedf",    2.0,   3, { 1,13,19}},     //   2.0 AC[abcd] D[aecf] E2[bedf] 
    {"abcd,bace,ed",     -1.0,   3, { 1, 8,18}},     //  -1.0 AC[abcd] D[bace] E1[ed] 
    {"abcd,eacf,bfde",   -1.0,   3, { 1, 8,19}},     //  -1.0 AC[abcd] D[eacf] E2[bfde] 
    {"ab,acbd,cd",        2.0,   3, { 3,13,18}},     //   2.0 AE[ab] D[acbd] E1[cd] 
    {"ab,cabd,dc",       -1.0,   3, { 3, 8,18}},     //  -1.0 AE[ab] D[cabd] E1[dc] 
	};
  ...
  static void GetMethodInfo(FMethodInfo &Out) {
    ...
    Out.nTensorDecls = 20;
    Out.EqsRes = FEqSet(&EqsRes[0], 14, "MRLCC3/Res");
  };
};
