namespace NEVPT_CCAV {
  ...
  FEqInfo bVec[4] = {
    {"IJPA,RP,lIR,lJA",   4.0,   4, { 3,15,13,14}}, //  4.0 b[IJPA] delta[RP] W[IJRA]
    {"IJPA,RP,lIR,lJA",  -2.0,   4, { 3,16,13,14}}, // -2.0 b[IJPA] E1[RP]    W[IJRA]
    {"IJPA,RP,lJR,lIA",  -2.0,   4, { 3,15,13,14}}, // -2.0 b[IJPA] delta[RP] W[JIRA]
    {"IJPA,RP,lJR,lIA",   1.0,   4, { 3,16,13,14}}, //  1.0 b[IJPA] E1[RP]    W[JIRA]
  };
