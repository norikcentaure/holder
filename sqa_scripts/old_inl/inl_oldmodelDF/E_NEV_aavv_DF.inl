namespace NEVPT_AAVV {
  ...
  FEqInfo bVec[4] = {
    {"ABRS,lAP,lBQ,RSPQ",  0.25,   4, { 3,12,12,13}}, // 0.5 b[ABRS] W[ABPQ] E2[RSPQ]
    {"BARS,lAP,lBQ,RSQP",  0.25,   4, { 3,12,12,13}}, // 0.5 b[BARS] W[ABPQ] E2[RSQP]
    {"ABRS,lBP,lAQ,RSQP",  0.25,   4, { 3,12,12,13}}, // 0.5 b[ABRS] W[BAPQ] E2[RSQP]
    {"BARS,lBP,lAQ,RSPQ",  0.25,   4, { 3,12,12,13}}, // 0.5 b[BARS] W[BAPQ] E2[RSPQ]
  };
