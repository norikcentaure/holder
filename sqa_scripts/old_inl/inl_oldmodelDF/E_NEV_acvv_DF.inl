namespace NEVPT_ACVV {
  ...
  FTensorDecl TensorDecls[19] = {
    ...
    {"abcd,ae,becf,df",         -1.0,   4, { 6,11, 5,15}},     //  -1.0 Ap[abcd] f[ae] p[becf] E1[df] 
    ...
    {"abcd,be,eacf,df",         -1.0,   4, { 6,11, 5,15}},     //  -1.0 Ap[abcd] f[be] p[eacf] E1[df] 
    {"abcd,abce,feg,fhi,dhgi",  -2.0,   5, { 6, 5,12,12,16}},  //  -2.0 Ap[abcd] p[abce] W[feg] W[fhi] E2[dhgi] 
    {"abcd,bace,feg,fhi,dhgi",   1.0,   5, { 6, 5,12,12,16}},  //   1.0 Ap[abcd] p[bace] W[feg] W[fhi] E2[dhgi] 
	};

  FEqInfo bVec[2] = {
    {"ABIP,RP,lAI,lBR",   2.0,   4, { 3,15,14,13}}, //  2.0 b[ABIP] E1[RP] W[ABIR]
    {"ABIP,RP,lBI,lAR",  -1.0,   4, { 3,15,14,13}}, // -1.0 b[ABIP] E1[RP] W[BAIR]
  };
