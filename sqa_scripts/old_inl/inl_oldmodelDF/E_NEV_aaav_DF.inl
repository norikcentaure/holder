namespace NEVPT_AAAV {
  ...
  FEqInfo bVec[5] = {
    {"AUVW,lAQ,lPR,WR,QP,VU",   1.0,   6, { 3,13,12,15,14,14}}, // 1.0 b[auvw] W[apqr] E1[wr] delta[qp] delta[vu]
    {"AUVW,lAQ,lPR,VWRU,QP" ,   1.0,   5, { 3,13,12,16,14}   }, // 1.0 b[auvw] W[apqr] E2[vwru] delta[qp]
    {"AUVW,lAQ,lPR,VWQR,PU" ,   1.0,   5, { 3,13,12,16,14}   }, // 1.0 b[auvw] W[apqr] E2[vwqr] delta[pu]
    {"AUVW,lAQ,lPR,PWRQ,VU" ,   1.0,   5, { 3,13,12,16,14}   }, // 1.0 b[auvw] W[apqr] E2[pwrq] delta[vu]
    {"AUVW,lAQ,lPR,PVWRQU"  ,   1.0,   4, { 3,13,12,18}      }, // 1.0 b[auvw] W[apqr] E3[pvwrqu]
  };
