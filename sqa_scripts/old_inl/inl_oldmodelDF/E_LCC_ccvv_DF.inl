namespace MRLCC_CCVV {
  ...
  FEqInfo bVec[4] = {
    {"CDKL,LM,lCK,lDM",   2.0,   4, { 3,20,18,18}}, //  2.0 b[CDKL] deltac[LM] W[CDKM]
    {"CDKL,LM,lDK,lCM",  -1.0,   4, { 3,20,18,18}}, // -1.0 b[CDKL] deltac[LM] W[DCKM]
    {"CDKL,LM,lCM,lDK",  -1.0,   4, { 3,20,18,18}}, // -1.0 b[CDKL] deltac[LM] W[CDMK]
    {"CDKL,LM,lDM,lCK",   2.0,   4, { 3,20,18,18}}, //  2.0 b[CDKL] deltac[LM] W[DCMK]
  };
