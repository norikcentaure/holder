namespace NEVPT_CCVV {
  ...
  FEqInfo bVec[4] = {
    {"CDKL,LM,CDKM",   2.0,   3, { 3,12,11}}, //  2.0 b[CDKL] deltac[LM] V[CDKM]
    {"CDKL,LM,DCKM",  -1.0,   3, { 3,12,11}}, // -1.0 b[CDKL] deltac[LM] V[DCKM]
    {"CDKL,LM,CDMK",  -1.0,   3, { 3,12,11}}, // -1.0 b[CDKL] deltac[LM] V[CDMK]
    {"CDKL,LM,DCMK",   2.0,   3, { 3,12,11}}, //  2.0 b[CDKL] deltac[LM] V[DCMK]
  };
