...
//  {"abcd,efgh,baie,fgihcd",   1.0,   4, { 6,11, 5,18}},  //   1.0 Ap[abcd] W[efgh] p[baie] E3[fgihcd] 
  ...
  FEqInfo bVec[14] = {
    {"KLRS,PR,KLPS"  ,   2.0,   3, { 3,13,12}}, //  2.0 b[KLRS] delta[PR] delta[QS] V[KLPQ]
    {"KLRS,PS,KLPR"  ,  -1.0,   3, { 3,13,12}}, // -1.0 b[KLRS] delta[PS] delta[QR] V[KLPQ]
    {"KLRS,QS,KLRQ"  ,  -1.0,   3, { 3,14,12}}, // -1.0 b[KLRS] E1[QS]    delta[PR] V[KLPQ]
    {"KLRS,QR,KLSQ"  ,   0.5,   3, { 3,14,12}}, //  0.5 b[KLRS] E1[QR]    delta[PS] V[KLPQ]
    {"KLRS,PS,KLPR"  ,   0.5,   3, { 3,14,12}}, //  0.5 b[KLRS] E1[PS]    delta[QR] V[KLPQ]
    {"KLRS,PR,KLPS"  ,  -1.0,   3, { 3,14,12}}, // -1.0 b[KLRS] E1[PR]    delta[QS] V[KLPQ]
    {"KLRS,PQRS,KLPQ",   0.5,   3, { 3,15,12}}, //  0.5 b[KLRS] E2[PQRS]            V[KLPQ]
    {"KLRS,PS,LKPR"  ,   2.0,   3, { 3,13,12}}, //  2.0 b[KLRS] delta[PS] delta[QR] V[LKPQ]
    {"KLRS,PR,LKPS"  ,  -1.0,   3, { 3,13,12}}, // -1.0 b[KLRS] delta[PR] delta[QS] V[LKPQ]
    {"KLRS,QR,LKSQ"  ,  -1.0,   3, { 3,14,12}}, // -1.0 b[KLRS] E1[QR]    delta[PS] V[LKPQ]
    {"KLRS,QS,LKRQ"  ,   0.5,   3, { 3,14,12}}, //  0.5 b[KLRS] E1[QS]    delta[PR] V[LKPQ]
    {"KLRS,PR,LKPS"  ,   0.5,   3, { 3,14,12}}, //  0.5 b[KLRS] E1[PR]    delta[QS] V[LKPQ]
    {"KLRS,PS,LKPR"  ,  -1.0,   3, { 3,14,12}}, // -1.0 b[KLRS] E1[PS]    delta[QR] V[LKPQ]
    {"KLRS,PQSR,LKPQ",   0.5,   3, { 3,15,12}}, //  0.5 b[KLRS] E2[PQSR]            V[LKPQ]
  };
  ...
  static void GetMethodInfo(FMethodInfo &Out) {
    ...
    Out.nTensorDecls = 18;
    Out.EqsRes = FEqSet(&EqsRes[0], 118, "NEVPT_CCAA/Res");
