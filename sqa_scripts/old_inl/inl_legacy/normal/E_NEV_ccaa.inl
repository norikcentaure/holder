namespace NEVPT_CCAA {
  ...
  FEqInfo bVec[14] = {
    {"KLRS,PR,KLPS"  ,   2.0,   3, { 3,13,12}}, //  2.0 b[KLRS] delta[PR] delta[QS] W[KLPQ]
    {"KLRS,PS,KLPR"  ,  -1.0,   3, { 3,13,12}}, // -1.0 b[KLRS] delta[PS] delta[QR] W[KLPQ]
    {"KLRS,QS,KLRQ"  ,  -1.0,   3, { 3,14,12}}, // -1.0 b[KLRS] E1[QS]    delta[PR] W[KLPQ]
    {"KLRS,QR,KLSQ"  ,   0.5,   3, { 3,14,12}}, //  0.5 b[KLRS] E1[QR]    delta[PS] W[KLPQ]
    {"KLRS,PS,KLPR"  ,   0.5,   3, { 3,14,12}}, //  0.5 b[KLRS] E1[PS]    delta[QR] W[KLPQ]
    {"KLRS,PR,KLPS"  ,  -1.0,   3, { 3,14,12}}, // -1.0 b[KLRS] E1[PR]    delta[QS] W[KLPQ]
    {"KLRS,PQRS,KLPQ",   0.5,   3, { 3,15,12}}, //  0.5 b[KLRS] E2[PQRS]            W[KLPQ]
    {"KLRS,PS,LKPR"  ,   2.0,   3, { 3,13,12}}, //  2.0 b[KLRS] delta[PS] delta[QR] W[LKPQ]
    {"KLRS,PR,LKPS"  ,  -1.0,   3, { 3,13,12}}, // -1.0 b[KLRS] delta[PR] delta[QS] W[LKPQ]
    {"KLRS,QR,LKSQ"  ,  -1.0,   3, { 3,14,12}}, // -1.0 b[KLRS] E1[QR]    delta[PS] W[LKPQ]
    {"KLRS,QS,LKRQ"  ,   0.5,   3, { 3,14,12}}, //  0.5 b[KLRS] E1[QS]    delta[PR] W[LKPQ]
    {"KLRS,PR,LKPS"  ,   0.5,   3, { 3,14,12}}, //  0.5 b[KLRS] E1[PR]    delta[QS] W[LKPQ]
    {"KLRS,PS,LKPR"  ,  -1.0,   3, { 3,14,12}}, // -1.0 b[KLRS] E1[PS]    delta[QR] W[LKPQ]
    {"KLRS,PQSR,LKPQ",   0.5,   3, { 3,15,12}}, //  0.5 b[KLRS] E2[PQSR]            W[LKPQ]
  };
