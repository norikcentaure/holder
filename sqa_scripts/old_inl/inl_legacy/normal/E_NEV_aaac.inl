namespace NEVPT_AAAC {
  ...
  FEqInfo bVec[7] = {
    {"ABCE,ABCD,ED"    ,   2.0,   3, { 3,13,15}}, //  2.0 b[abce] W[abcd] E1[ed]
    {"ACBE,ABCD,ED"    ,  -1.0,   3, { 3,13,15}}, // -1.0 b[acbe] W[abcd] E1[ed]
    {"ABEF,ABCD,CFED"  ,  -1.0,   3, { 3,13,16}}, // -1.0 b[abef] W[abcd] E2[cfed]
    {"ACEF,ABCD,BFDE"  ,  -1.0,   3, { 3,13,16}}, // -1.0 b[acef] W[abcd] E2[bfde]
    {"AEBF,ABCD,CFDE"  ,  -1.0,   3, { 3,13,16}}, // -1.0 b[aebf] W[abcd] E2[cfde]
    {"AECF,ABCD,BFDE"  ,   2.0,   3, { 3,13,16}}, //  2.0 b[aecf] W[abcd] E2[bfde]
    {"AEFG,ABCD,BCGDFE",  -1.0,   3, { 3,13,18}}, // -1.0 b[aefg] W[abcd] E3[bcgdfe]
  };
