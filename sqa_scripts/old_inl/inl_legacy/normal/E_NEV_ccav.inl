namespace NEVPT_CCAV {
  ...
  FEqInfo bVec[4] = {
    {"IJPA,RP,IJRA",   4.0,   3, { 3,14,13}}, //  4.0 b[IJPA] delta[RP] W[IJRA]
    {"IJPA,RP,IJRA",  -2.0,   3, { 3,15,13}}, // -2.0 b[IJPA] E1[RP]    W[IJRA]
    {"IJPA,RP,JIRA",  -2.0,   3, { 3,14,13}}, // -2.0 b[IJPA] delta[RP] W[JIRA]
    {"IJPA,RP,JIRA",   1.0,   3, { 3,15,13}}, //  1.0 b[IJPA] E1[RP]    W[JIRA]
  };
