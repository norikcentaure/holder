namespace NEVPT_AAVV {
  ...
  FEqInfo bVec[4] = {
    {"ABRS,ABPQ,RSPQ",  0.25,   3, { 3,12,13}}, // 0.5 b[ABRS] W[ABPQ] E2[RSPQ]
    {"BARS,ABPQ,RSQP",  0.25,   3, { 3,12,13}}, // 0.5 b[BARS] W[ABPQ] E2[RSQP]
    {"ABRS,BAPQ,RSQP",  0.25,   3, { 3,12,13}}, // 0.5 b[ABRS] W[BAPQ] E2[RSQP]
    {"BARS,BAPQ,RSPQ",  0.25,   3, { 3,12,13}}, // 0.5 b[BARS] W[BAPQ] E2[RSPQ]
  };
