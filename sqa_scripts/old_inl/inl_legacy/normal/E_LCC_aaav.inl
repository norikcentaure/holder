namespace MRLCC_AAAV {
  ...
  FEqInfo bVec[5] = {
    {"AUVW,APQR,WR,QP,VU",   1.0,   5, { 3,19,22,20,20}}, // 1.0 b[auvw] W[apqr] E1[wr] delta[qp] delta[vu]
    {"AUVW,APQR,VWRU,QP" ,   1.0,   4, { 3,19,23,20}   }, // 1.0 b[auvw] W[apqr] E2[vwru] delta[qp]
    {"AUVW,APQR,VWQR,PU" ,   1.0,   4, { 3,19,23,20}   }, // 1.0 b[auvw] W[apqr] E2[vwqr] delta[pu]
    {"AUVW,APQR,PWRQ,VU" ,   1.0,   4, { 3,19,23,20}   }, // 1.0 b[auvw] W[apqr] E2[pwrq] delta[vu]
    {"AUVW,APQR,PVWRQU"  ,   1.0,   3, { 3,19,25}      }, // 1.0 b[auvw] W[apqr] E3[pvwrqu]
  };
