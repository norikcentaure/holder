namespace NEVPT_CCAA {
  ...
  FEqInfo bVec[14] = {
    {"KLRS,PR,lKP,lLS"  ,   2.0,   4, { 3,13,12,12}}, //  2.0 b[KLRS] delta[PR] delta[QS] V[KLPQ]
    {"KLRS,PS,lKP,lLR"  ,  -1.0,   4, { 3,13,12,12}}, // -1.0 b[KLRS] delta[PS] delta[QR] V[KLPQ]
    {"KLRS,QS,lKR,lLQ"  ,  -1.0,   4, { 3,14,12,12}}, // -1.0 b[KLRS] E1[QS]    delta[PR] V[KLPQ]
    {"KLRS,QR,lKS,lLQ"  ,   0.5,   4, { 3,14,12,12}}, //  0.5 b[KLRS] E1[QR]    delta[PS] V[KLPQ]
    {"KLRS,PS,lKP,lLR"  ,   0.5,   4, { 3,14,12,12}}, //  0.5 b[KLRS] E1[PS]    delta[QR] V[KLPQ]
    {"KLRS,PR,lKP,lLS"  ,  -1.0,   4, { 3,14,12,12}}, // -1.0 b[KLRS] E1[PR]    delta[QS] V[KLPQ]
    {"KLRS,PQRS,lKP,lLQ",   0.5,   4, { 3,15,12,12}}, //  0.5 b[KLRS] E2[PQRS]            V[KLPQ]
    {"KLRS,PS,lLP,lKR"  ,   2.0,   4, { 3,13,12,12}}, //  2.0 b[KLRS] delta[PS] delta[QR] V[LKPQ]
    {"KLRS,PR,lLP,lKS"  ,  -1.0,   4, { 3,13,12,12}}, // -1.0 b[KLRS] delta[PR] delta[QS] V[LKPQ]
    {"KLRS,QR,lLS,lKQ"  ,  -1.0,   4, { 3,14,12,12}}, // -1.0 b[KLRS] E1[QR]    delta[PS] V[LKPQ]
    {"KLRS,QS,lLR,lKQ"  ,   0.5,   4, { 3,14,12,12}}, //  0.5 b[KLRS] E1[QS]    delta[PR] V[LKPQ]
    {"KLRS,PR,lLP,lKS"  ,   0.5,   4, { 3,14,12,12}}, //  0.5 b[KLRS] E1[PR]    delta[QS] V[LKPQ]
    {"KLRS,PS,lLP,lKR"  ,  -1.0,   4, { 3,14,12,12}}, // -1.0 b[KLRS] E1[PS]    delta[QR] V[LKPQ]
    {"KLRS,PQSR,lLP,lKQ",   0.5,   4, { 3,15,12,12}}, //  0.5 b[KLRS] E2[PQSR]            V[LKPQ]
  };
