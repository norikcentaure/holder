namespace MRLCC_AAVV {
  ...
  FEqInfo bVec[4] = {
    {"ABRS,lAP,lBQ,RSPQ",  0.25,   4, { 3,17,17,21}}, // 0.5 b[ABRS] V[ABPQ] E2[RSPQ]
    {"BARS,lAP,lBQ,RSQP",  0.25,   4, { 3,17,17,21}}, // 0.5 b[BARS] V[ABPQ] E2[RSQP]
    {"ABRS,lBP,lAQ,RSQP",  0.25,   4, { 3,17,17,21}}, // 0.5 b[ABRS] V[BAPQ] E2[RSQP]
    {"BARS,lBP,lAQ,RSPQ",  0.25,   4, { 3,17,17,21}}, // 0.5 b[BARS] V[BAPQ] E2[RSPQ]
  };
