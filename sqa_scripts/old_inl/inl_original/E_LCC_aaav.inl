...
//Number of terms :  86
	FEqInfo EqsRes[86] = {
		...
		{"abcd,ef,aegh,cdfgbh",             1.0,      4, {6,10,5,24}},          		//   1.0 Ap[abcd] k[ef] p[aegh] E3[cdfgbh] 
		{"abcd,ef,ageh,cdgfbh",            -1.0,      4, {6,10,5,24}},          		//  -1.0 Ap[abcd] k[ef] p[ageh] E3[cdgfbh] 
		{"abcd,ef,aghe,cdghbf",            -1.0,      4, {6,10,5,24}},          		//  -1.0 Ap[abcd] k[ef] p[aghe] E3[cdghbf] 
		{"abcd,ae,efgh,cdfgbh",             1.0,      4, {6,11,5,24}},          		//   1.0 Ap[abcd] k[ae] p[efgh] E3[cdfgbh] 
		{"abjc,defg,adhi,cefhgi,jb",        1.0,      5, {6,12,5,24,20}},       		//   1.0 Ap[abjc] W[defg] p[adhi] E3[cefhgi] delta[jb] 
		{"abjc,defg,ahdi,cehfgi,jb",       -1.0,      5, {6,12,5,24,20}},       		//  -1.0 Ap[abjc] W[defg] p[ahdi] E3[cehfgi] delta[jb] 
		{"abjc,defg,ahid,cehigf,jb",       -1.0,      5, {6,12,5,24,20}},       		//  -1.0 Ap[abjc] W[defg] p[ahid] E3[cehigf] delta[jb] 
		{"abcd,befg,aehi,cdghfi",           1.0,      4, {6,12,5,24}},          		//   1.0 Ap[abcd] W[befg] p[aehi] E3[cdghfi] 
		{"abcd,befg,afhi,cdehig",           1.0,      4, {6,12,5,24}},          		//   1.0 Ap[abcd] W[befg] p[afhi] E3[cdehig] 
		{"abcd,befg,ahei,cdhgfi",          -1.0,      4, {6,12,5,24}},          		//  -1.0 Ap[abcd] W[befg] p[ahei] E3[cdhgfi] 
		{"abcd,befg,ahie,cdhifg",          -1.0,      4, {6,12,5,24}},          		//  -1.0 Ap[abcd] W[befg] p[ahie] E3[cdhifg] 
		{"abcd,efgh,abei,cdfgih",          -1.0,      4, {6,12,5,24}},          		//  -1.0 Ap[abcd] W[efgh] p[abei] E3[cdfgih] 
		{"abcd,efgh,abie,cdfigh",          -1.0,      4, {6,12,5,24}},          		//  -1.0 Ap[abcd] W[efgh] p[abie] E3[cdfigh] 
		{"abcd,efgh,aief,cdigbh",          -1.0,      4, {6,12,5,24}},          		//  -1.0 Ap[abcd] W[efgh] p[aief] E3[cdigbh] 
		{"abcd,efgh,aije,cdfgbh,ji",       -1.0,      5, {6,12,5,24,20}},       		//  -1.0 Ap[abcd] W[efgh] p[aije] E3[cdfgbh] delta[ji] 
		{"abjc,daef,fghi,cdghei,jb",        1.0,      5, {6,13,5,24,20}},       		//   1.0 Ap[abjc] W[daef] p[fghi] E3[cdghei] delta[jb] 
		{"abcd,baef,fghi,cdghei",           1.0,      4, {6,13,5,24}},          		//   1.0 Ap[abcd] W[baef] p[fghi] E3[cdghei] 
		{"abcd,eafg,gbhi,cdehif",           1.0,      4, {6,13,5,24}},          		//   1.0 Ap[abcd] W[eafg] p[gbhi] E3[cdehif] 
		{"abcd,eafg,gehi,cdfhbi",           1.0,      4, {6,13,5,24}},          		//   1.0 Ap[abcd] W[eafg] p[gehi] E3[cdfhbi] 
		{"abcd,eafg,ghji,cdeibf,jh",        1.0,      5, {6,13,5,24,20}},       		//   1.0 Ap[abcd] W[eafg] p[ghji] E3[cdeibf] delta[jh] 
		{"abjc,daef,eghi,cdgfhi,jb",        1.0,      5, {6,14,5,24,20}},       		//   1.0 Ap[abjc] W[daef] p[eghi] E3[cdgfhi] delta[jb] 
		{"abcd,baef,eghi,cdgfhi",           1.0,      4, {6,14,5,24}},          		//   1.0 Ap[abcd] W[baef] p[eghi] E3[cdgfhi] 
		{"abcd,eafg,fbhi,cdegih",           1.0,      4, {6,14,5,24}},          		//   1.0 Ap[abcd] W[eafg] p[fbhi] E3[cdegih] 
		{"abcd,eafg,fghi,cdeibh",           1.0,      4, {6,14,5,24}},          		//   1.0 Ap[abcd] W[eafg] p[fghi] E3[cdeibh] 
		{"abcd,eafg,fhji,cdegbi,jh",        1.0,      5, {6,14,5,24,20}},       		//   1.0 Ap[abcd] W[eafg] p[fhji] E3[cdegbi] delta[jh] 
		{"abcd,efjg,afhi,cdghbi,je",        2.0,      5, {6,15,5,24,21}},       		//   2.0 Ap[abcd] W[efjg] p[afhi] E3[cdghbi] delta[je] 
		{"abcd,efjg,ahfi,cdhgbi,je",       -2.0,      5, {6,15,5,24,21}},       		//  -2.0 Ap[abcd] W[efjg] p[ahfi] E3[cdhgbi] delta[je] 
		{"abcd,efjg,ahif,cdhibg,je",       -2.0,      5, {6,15,5,24,21}},       		//  -2.0 Ap[abcd] W[efjg] p[ahif] E3[cdhibg] delta[je] 
		{"abcd,efgj,aghi,cdfhbi,je",       -1.0,      5, {6,16,5,24,21}},       		//  -1.0 Ap[abcd] W[efgj] p[aghi] E3[cdfhbi] delta[je] 
		{"abcd,efgj,ahfi,cdhgbi,je",        1.0,      5, {6,16,5,24,21}},       		//   1.0 Ap[abcd] W[efgj] p[ahfi] E3[cdhgbi] delta[je] 
		{"abcd,efgj,ahif,cdhibg,je",        1.0,      5, {6,16,5,24,21}},       		//   1.0 Ap[abcd] W[efgj] p[ahif] E3[cdhibg] delta[je] 
		{"abcd,eajf,fghi,cdghbi,je",        2.0,      5, {6,17,5,24,21}},       		//   2.0 Ap[abcd] W[eajf] p[fghi] E3[cdghbi] delta[je] 
		{"abcd,eafj,fghi,cdghbi,je",       -1.0,      5, {6,18,5,24,21}},       		//  -1.0 Ap[abcd] W[eafj] p[fghi] E3[cdghbi] delta[je] 
		{"abcd,efgh,aeij,cdfgibhj",         1.0,      4, {6,12,5,25}},          		//   1.0 Ap[abcd] W[efgh] p[aeij] E4[cdfgibhj] 
		{"abcd,efgh,aiej,cdfigbhj",        -1.0,      4, {6,12,5,25}},          		//  -1.0 Ap[abcd] W[efgh] p[aiej] E4[cdfigbhj] 
		{"abcd,efgh,aije,cdfijbhg",        -1.0,      4, {6,12,5,25}},          		//  -1.0 Ap[abcd] W[efgh] p[aije] E4[cdfijbhg] 
		{"abcd,eafg,ghij,cdehibfj",         1.0,      4, {6,13,5,25}},          		//   1.0 Ap[abcd] W[eafg] p[ghij] E4[cdehibfj] 
		{"abcd,eafg,fhij,cdehgbij",         1.0,      4, {6,14,5,25}},          		//   1.0 Ap[abcd] W[eafg] p[fhij] E4[cdehgbij] 
  ...
  FEqInfo bVec[5] = {
    ...
    {"auvw,apqr,pvwrqu",    1.0  , 3, {3,19,24}},       // 1.0 b[auvw] V[apqr] E3[pvwrqu]
  };
