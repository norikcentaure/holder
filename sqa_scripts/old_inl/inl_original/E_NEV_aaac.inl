...
//Number of terms :  74
	FEqInfo EqsRes[74] = {
		...
		{"abcd,ef,aegh,dfgbhc",            -1.0,      4, {6,10,5,17}},          		//  -1.0 Ap[abcd] f[ef] p[aegh] E3[dfgbhc] 
		{"abcd,ef,ageh,dfgbch",            -1.0,      4, {6,10,5,17}},          		//  -1.0 Ap[abcd] f[ef] p[ageh] E3[dfgbch] 
		{"abcd,ef,aghe,dghbfc",             1.0,      4, {6,10,5,17}},          		//   1.0 Ap[abcd] f[ef] p[aghe] E3[dghbfc] 
		{"abcd,ae,efgh,dfgbhc",             1.0,      4, {6,11,5,17}},          		//   1.0 Ap[abcd] f[ae] p[efgh] E3[dfgbhc] 
		{"abcd,befg,aehi,dghfic",          -1.0,      4, {6,12,5,17}},          		//  -1.0 Ap[abcd] W[befg] p[aehi] E3[dghfic] 
		{"abcd,befg,afhi,dehigc",          -1.0,      4, {6,12,5,17}},          		//  -1.0 Ap[abcd] W[befg] p[afhi] E3[dehigc] 
		{"abcd,befg,ahei,dghfci",          -1.0,      4, {6,12,5,17}},          		//  -1.0 Ap[abcd] W[befg] p[ahei] E3[dghfci] 
		{"abcd,befg,ahfi,dehcgi",          -1.0,      4, {6,12,5,17}},          		//  -1.0 Ap[abcd] W[befg] p[ahfi] E3[dehcgi] 
		{"abcd,befg,ahie,dhifgc",           1.0,      4, {6,12,5,17}},          		//   1.0 Ap[abcd] W[befg] p[ahie] E3[dhifgc] 
		{"abcd,cefg,aehi,dghbif",          -1.0,      4, {6,12,5,17}},          		//  -1.0 Ap[abcd] W[cefg] p[aehi] E3[dghbif] 
		{"abcd,cefg,afhi,dehbgi",          -1.0,      4, {6,12,5,17}},          		//  -1.0 Ap[abcd] W[cefg] p[afhi] E3[dehbgi] 
		{"abcd,cefg,ahei,dghbfi",          -1.0,      4, {6,12,5,17}},          		//  -1.0 Ap[abcd] W[cefg] p[ahei] E3[dghbfi] 
		{"abcd,cefg,ahfi,dehbgi",           2.0,      4, {6,12,5,17}},          		//   2.0 Ap[abcd] W[cefg] p[ahfi] E3[dehbgi] 
		{"abcd,cefg,ahie,dhibgf",           1.0,      4, {6,12,5,17}},          		//   1.0 Ap[abcd] W[cefg] p[ahie] E3[dhibgf] 
		{"abcd,efgh,abei,dfgihc",          -1.0,      4, {6,12,5,17}},          		//  -1.0 Ap[abcd] W[efgh] p[abei] E3[dfgihc] 
		{"abcd,efgh,abie,dfighc",           1.0,      4, {6,12,5,17}},          		//   1.0 Ap[abcd] W[efgh] p[abie] E3[dfighc] 
		{"abcd,efgh,acei,dfgbhi",          -1.0,      4, {6,12,5,17}},          		//  -1.0 Ap[abcd] W[efgh] p[acei] E3[dfgbhi] 
		{"abcd,efgh,acie,dfibhg",           1.0,      4, {6,12,5,17}},          		//   1.0 Ap[abcd] W[efgh] p[acie] E3[dfibhg] 
		{"abcd,efgh,aebi,dfgchi",          -1.0,      4, {6,12,5,17}},          		//  -1.0 Ap[abcd] W[efgh] p[aebi] E3[dfgchi] 
		{"abcd,efgh,aeci,dfgbhi",           2.0,      4, {6,12,5,17}},          		//   2.0 Ap[abcd] W[efgh] p[aeci] E3[dfgbhi] 
		{"abcd,efgh,aefi,dghbic",          -1.0,      4, {6,12,5,17}},          		//  -1.0 Ap[abcd] W[efgh] p[aefi] E3[dghbic] 
		{"abcd,efgh,aibe,dfichg",           1.0,      4, {6,12,5,17}},          		//   1.0 Ap[abcd] W[efgh] p[aibe] E3[dfichg] 
		{"abcd,efgh,aice,dfibhg",          -2.0,      4, {6,12,5,17}},          		//  -2.0 Ap[abcd] W[efgh] p[aice] E3[dfibhg] 
		{"abcd,efgh,aeij,dfgibhjc",        -1.0,      4, {6,12,5,18}},          		//  -1.0 Ap[abcd] W[efgh] p[aeij] E4[dfgibhjc] 
		{"abcd,efgh,aiej,dfgibhcj",        -1.0,      4, {6,12,5,18}},          		//  -1.0 Ap[abcd] W[efgh] p[aiej] E4[dfgibhcj] 
		{"abcd,efgh,aije,dfijbhgc",         1.0,      4, {6,12,5,18}},          		//   1.0 Ap[abcd] W[efgh] p[aije] E4[dfijbhgc] 
	...
	FEqInfo bVec[7] = {
		...
		{"aefg,abcd,bcgdfe", -1.0  , 3, {3,13,17}}, // -1.0 b[aefg] V[abcd] E3[bcgdfe]
	};
