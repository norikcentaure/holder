...
//Number of terms :  34
	FEqInfo EqsRes[34] = {
		...
		{"abcd,ef,aegh,cdfgbh",             1.0,      4, {6,10,5,17}},          		//   1.0 Ap[abcd] f[ef] p[aegh] E3[cdfgbh] 
		{"abcd,ef,ageh,cdgfbh",            -1.0,      4, {6,10,5,17}},          		//  -1.0 Ap[abcd] f[ef] p[ageh] E3[cdgfbh] 
		{"abcd,ef,aghe,cdghbf",            -1.0,      4, {6,10,5,17}},          		//  -1.0 Ap[abcd] f[ef] p[aghe] E3[cdghbf] 
		{"abcd,ae,efgh,cdfgbh",             1.0,      4, {6,11,5,17}},          		//   1.0 Ap[abcd] f[ae] p[efgh] E3[cdfgbh] 
		{"abjc,defg,adhi,cefhgi,jb",        1.0,      5, {6,12,5,17,14}},       		//   1.0 Ap[abjc] W[defg] p[adhi] E3[cefhgi] delta[jb] 
		{"abjc,defg,ahdi,cehfgi,jb",       -1.0,      5, {6,12,5,17,14}},       		//  -1.0 Ap[abjc] W[defg] p[ahdi] E3[cehfgi] delta[jb] 
		{"abjc,defg,ahid,cehigf,jb",       -1.0,      5, {6,12,5,17,14}},       		//  -1.0 Ap[abjc] W[defg] p[ahid] E3[cehigf] delta[jb] 
		{"abcd,befg,aehi,cdghfi",           1.0,      4, {6,12,5,17}},          		//   1.0 Ap[abcd] W[befg] p[aehi] E3[cdghfi] 
		{"abcd,befg,afhi,cdehig",           1.0,      4, {6,12,5,17}},          		//   1.0 Ap[abcd] W[befg] p[afhi] E3[cdehig] 
		{"abcd,befg,ahei,cdhgfi",          -1.0,      4, {6,12,5,17}},          		//  -1.0 Ap[abcd] W[befg] p[ahei] E3[cdhgfi] 
		{"abcd,befg,ahie,cdhifg",          -1.0,      4, {6,12,5,17}},          		//  -1.0 Ap[abcd] W[befg] p[ahie] E3[cdhifg] 
		{"abcd,efgh,abei,cdfgih",          -1.0,      4, {6,12,5,17}},          		//  -1.0 Ap[abcd] W[efgh] p[abei] E3[cdfgih] 
		{"abcd,efgh,abie,cdfigh",          -1.0,      4, {6,12,5,17}},          		//  -1.0 Ap[abcd] W[efgh] p[abie] E3[cdfigh] 
		{"abcd,efgh,aief,cdigbh",          -1.0,      4, {6,12,5,17}},          		//  -1.0 Ap[abcd] W[efgh] p[aief] E3[cdigbh] 
		{"abcd,efgh,aije,cdfgbh,ji",       -1.0,      5, {6,12,5,17,14}},       		//  -1.0 Ap[abcd] W[efgh] p[aije] E3[cdfgbh] delta[ji] 
		{"abcd,efgh,aeij,cdfgibhj",         1.0,      4, {6,12,5,18}},          		//   1.0 Ap[abcd] W[efgh] p[aeij] E4[cdfgibhj] 
		{"abcd,efgh,aiej,cdfigbhj",        -1.0,      4, {6,12,5,18}},          		//  -1.0 Ap[abcd] W[efgh] p[aiej] E4[cdfigbhj] 
		{"abcd,efgh,aije,cdfijbhg",        -1.0,      4, {6,12,5,18}},          		//  -1.0 Ap[abcd] W[efgh] p[aije] E4[cdfijbhg] 
	...
	FEqInfo bVec[5] = {
		...
		{"auvw,apqr,pvwrqu",    1.0  , 3, {3,13,17}},       // 1.0 b[auvw] V[apqr] E3[pvwrqu]
	};
